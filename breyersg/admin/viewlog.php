              ...
              <div class="well">
                  <div class="panel-group">
                    <div class="panel panel-primary">
                      <div class="panel-heading">Maintenance Log</div>
                      <div class="panel-body">
                        ...
                        <table class="table table-hover table-bordered" id="table_maintenance">
                    <thead>
                        <tr>
                            <th>Plat No.</th>
                            <th>Date</th>
                       ...
                       <?php
                        $qry = "";
                        $qry = mysqli_query($con, "SELECT * FROM maintenance WHERE no_plat='".$plat_no."' ORDER BY maintenance_id desc");
                        while($row=mysqli_fetch_array($qry,MYSQLI_ASSOC)){
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['next_mileage'] ?></td>
                            </tr>
                                    <?php
                        }
                        ?>
